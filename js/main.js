document.addEventListener("DOMContentLoaded", () => {
    ...
    if (checkoutBtn) {
        checkoutBtn.addEventListener('click', () => {
            ...
            cartBody.innerHTML = `
                <div class="checkout-contacts" style="padding: 20px;">
                    ...
                    <button class="contact-select-btn" data-phone="5519981630376" style="width:100%; padding: 15px; margin-bottom:12px; border:1px solid #e0e0e0; border-radius:8px; background:#fff; cursor:pointer; text-align:left; display:flex; flex-direction:column; transition: border-color 0.2s;">
                        <strong style="color:#000; font-size: 1rem; margin-bottom: 4px;">Campinas</strong>
                        <span style="color:#666; font-size: 0.9rem;">(19) 98163-0376</span>
                    </button>
                    
                    <button class="contact-select-btn" data-phone="5521964366018" style="width:100%; padding: 15px; margin-bottom:12px; border:1px solid #e0e0e0; border-radius:8px; background:#fff; cursor:pointer; text-align:left; display:flex; flex-direction:column; transition: border-color 0.2s;">
                        <strong style="color:#000; font-size: 1rem; margin-bottom: 4px;">Rio de Janeiro</strong>
                        <span style="color:#666; font-size: 0.9rem;">(21) 96436-6018</span>
                    </button>
                    
                    <button id="cancel-contact-select" style="width:100%; padding: 15px; margin-top:15px; border:none; border-radius:8px; background:#f0f0f0; color:#333; cursor:pointer; font-weight:bold; font-size: 0.95rem; transition: background-color 0.2s;">Voltar ao carrinho</button>
                </div>
            `;
            ...
            document.getElementById('cancel-contact-select').addEventListener('click', () => {
                renderCart();
            });
        });
    }
